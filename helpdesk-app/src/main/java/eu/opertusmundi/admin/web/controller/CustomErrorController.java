 ...
 * HTTP status code is always set to OK (200). For 401/403/404 errors, the default
 * "index" view is returned and navigation is deferred to the client-side router.
 * Any other error is redirected to client-side /error/500 route.
 *
...
public class CustomErrorController extends BasicErrorController {
    ...
    /**
     * Mapping for handling HTML responses
     */
    @Override
    ...
    public ModelAndView errorHtml(HttpServletRequest request, HttpServletResponse response) {
		...
		case NOT_FOUND:
			// Client-side router will resolve requested path to 404
    ...
    /**
     * Mapping for handling API errors
     */
    @Override
    @RequestMapping
